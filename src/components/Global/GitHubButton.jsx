...
const GitHubButton = ({text}) => {
  ...
  return (
    <div className="flex justify-center active:scale-95 transition">
      <a
        href="#"
        // target="_blank"
        ...
        <button
          className="absolute inset-0 rounded-lg bg-transparent cursor-pointer flex justify-center min-w-2"
          aria-label="Get Started"
          type="button"
          onMouseEnter={() => setIsHovered(true)}
          onMouseLeave={() => setIsHovered(false)}>
          <span className=" flex  items-center justify-between px-4 gap-2   rounded-lg text-white text-xl font-semibold tracking-wide whitespace-nowrap">
